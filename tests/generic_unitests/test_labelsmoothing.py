...
class TestLossFunction(unittest.TestCase):
    def setUp(self):
        ...
        self.params["loss_name"] = "lablesmoothing"
    ...
    def test_epsilon0_0(self):
        ...
        input_dim = 32 * 32 * 3  # 28x28 FashionMNIST data
        output_dim = 100
        ...
        for iteration, (X, y) in enumerate(trn_dl):
            ...
            logit_grad_derived = (
                ...
                + self.params["epsilon"] * (probs - 1.0 / output_dim)
            ) / batch_size
            ...
            try:
                ...
                print(loss3)
                print(loss3_logit_grad)
                print(logit_grad_derived)
                index = torch.where(
                    torch.ge(
                        torch.abs(torch.add(loss3_logit_grad, -logit_grad_derived)),
                        1e-1,
                ...
                print(y)
                print(index)
                print(loss3_logit_grad[index])
                print(logit_grad_derived[index])
                break
